...
public class Transformador {
    ...
    public Automata minimizar(Automata automata) {
        ...
        if (alfabeto.contains("E")) {
            JOptionPane.showMessageDialog(null, "Eliminando transiciones vacias");

            quitarTansicionesVacias();
            JOptionPane.showMessageDialog(null, "Transiciones vacias eliminadas");

        } else {
            JOptionPane.showMessageDialog(null, "No tiene transiciones vacias");


        }
        if (noEsDeterminista()) {
            JOptionPane.showMessageDialog(null, "Eliminando Transiciones de más de un Símbolo");

            TransicionesVacias();
            JOptionPane.showMessageDialog(null, "Descompuesto en Transiciones Unitarias");
        ...
        JOptionPane.showMessageDialog(null, "El automata ha sido minimizado");

        return new Automata(nombre, numestados, alfabeto, estadoInicial, estadoFinal, tabtrans);

    }

    private void TransicionesVacias() {
